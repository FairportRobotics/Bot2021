...
public class ShooterDebugMaxRPMCommand extends Command {

    private static final Logger log = LogManager.getLogger(ShooterDebugMaxRPMCommand.class);

    public ShooterDebugMaxRPMCommand() {
