...
public class OperatorBox {
    ...
    public OperatorBox() {
        ...
        buttons[1][0] = new JoystickButton(operatorBox2,1);
        buttons[2][0] = new JoystickButton(operatorBox1,2);
        buttons[3][0] = new JoystickButton(operatorBox2,2);
        ...
        buttons[3][2] = new JoystickButton(operatorBox1,10);
        buttons[0][3] = new JoystickButton(operatorBox2,3);
        buttons[1][3] = new JoystickButton(operatorBox2,4);
        buttons[2][3] = new JoystickButton(operatorBox2,5);
